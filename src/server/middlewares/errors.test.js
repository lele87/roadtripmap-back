...
describe("Given generalError function", () => {
  ...
  describe("When it receives an error without statuscode and message 'General error'", () => {
    test("Then it should call a response method with status code 500 and message 'General error'", () => {
      const error = {
        statuscode: 500,
        customMessage: "General error",
      };
